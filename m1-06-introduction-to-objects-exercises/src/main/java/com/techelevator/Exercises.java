...
public class Exercises {
	...
	public String nonStart(String a, String b) {
		//overloaded method *********LOOK THIS UP ******************8
			
		String temp = a.substring(1);
		String bigB = b.substring(1);
		return temp + bigB;
	...
	public String left2(String str) {
		String rob = str.substring(0,2);
		String stark = str.substring(2);
	...
	public String right2(String str) {
		int lenMin = str.length()-2;
		
		String rotate = str.substring(lenMin);
		String lenmin2 = str.substring(0,lenMin);
		return rotate + lenmin2;
	...
	public String theEnd(String str, boolean front) {
		String rotate = str.substring(0, 1);
		int restOf = str.length()-1;
		String backEnd = str.substring(restOf);
	...
	public String middleTwo(String str) {
		...
		String answer = str.substring(middle, middle+2);
	...
	public String nTwice(String str, int n) {
		...
		return str.substring(0, n) + str.substring(addN-n);
	}
