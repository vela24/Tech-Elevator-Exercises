...
public class ProjectsCLI {
	...
	private Menu menu;
	private DepartmentDAO departmentDAO; //THESE ARE INTERFACES, NOT CLASSES. CONCRETE IMPLEMENTATION OF DEPARTMENT DAO JDBC DEPARTMENT
	...
	public ProjectsCLI() {
		...
		departmentDAO = new JDBCDepartmentDAO(dataSource); // THIS IS THE ONE LINE OF CODE YOU HAVE TO CHANGE. 
	...
	private void handleAddDepartment() {
		...
		newDepartment = departmentDAO.createDepartment(newDepartment); // THIS IS AN OBJECT OF DEPARTMENT DAO THIS TYPE OF VARIABLE IS DEPARTMENTDAO - WHICH IS AN INTERFACE. WE CANT CREATE AN INSTANCE OF AN INTERFACE EVER. CREATE AN INSTANCE OF AN OBJECT THAT CRREATES AN INSTANCE OF THE DEPARTMENT DAO WHICH IS LINE 82
